import{_ as l,N as o,U as a,a7 as d,V as e,a5 as n,W as t,a6 as i,F as r}from"./framework-b080531d.js";const c={},u=e("h1",{id:"记录线上环境-jenkins-vue-打包失败-error-code-elifecycle",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#记录线上环境-jenkins-vue-打包失败-error-code-elifecycle","aria-hidden":"true"},"#"),n(" 记录线上环境 Jenkins Vue 打包失败 error code ELIFECYCLE")],-1),v=e("p",null,"Jenkins 里面的 Nodejs 版本换了下，然后自动打包的时候老是失败，提取了下日志信息。",-1),b=i(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>0 info it worked if it ends with ok
